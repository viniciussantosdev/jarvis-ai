...
Pré-requisitos
Python 3.10+
Ollama instalado, com o modelo baixado:
  ollama pull llama3.2:3b
Conta no Spotify for Developers (para tocar músicas)
Chave de API do NewsAPI (para notícias)
Instalação
Clone o repositório:
...
No Spotify for Developers, configure o Redirect URI do seu app como:
   http://127.0.0.1:8888/callback
Ajuste os caminhos dos seus aplicativos em config.py (VS Code, Claude Desktop, Spotify) conforme a instalação do seu computador.
Como usar
